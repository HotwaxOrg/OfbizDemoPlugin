...
public class OfbizDemoServices {
    ...
    public static Map<String, Object> createOfbizDemo(DispatchContext dcx, Map<String, ? extends Object> context){
        Map<String, Object> result = ServiceUtil.returnSuccess();
        Delegator delegator = dcx.getDelegator();
        try {
            GenericValue ofbizDemo = delegator.makeValue("OfbizDemoEntity");
